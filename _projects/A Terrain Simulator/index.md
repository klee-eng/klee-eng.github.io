...
description:  This project was completed for my haptics class, where the final assignment was to design and build a haptic device that a use can interact with. The project was open-ended, allowing for creative interpretation of what kind of haptic experience to create.
skills: 
- Rapid Prototyping
- Arduino
